...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        num_messages, words, num_media_messages, num_links = helperr.fetch_stats(selected_user, df)
        st.title("Top Statistics")
        ...
        if selected_user == 'Overall':
            ...
            x, new_df = helperr.most_busy_users(df)
            fig, ax = plt.subplots()
    #
            col1, col2 = st.columns(2)
    #
        ...
        # emoji analysis
        emoji_df = helperr.emoji_helper(selected_user, df)
